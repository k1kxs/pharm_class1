...
router.post('/generate-html', async (req, res) => {
    try {
      ...
      `;
        ...
        const htmlPath = path_1.default.join(tempDir, 'export.html');
    ...
    try {
      ...
      `;
        ...
        const fixTablesResult = await page.evaluate(() => {
            ...
            if (typeof window.detectAndFixTables === 'function') {
                return window.detectAndFixTables();
            }
            return null;
        });
        ...
        await page.evaluate(() => {
            ...
            function expandAllElements() {
                ...
                const allTabElements = tabSelectors.flatMap(selector => Array.from(document.querySelectorAll(selector)));
        ...
        const contentStats = await page.evaluate(() => {
            ...
            const getVisibleCount = (elements) => {
                let count = 0;
                elements.forEach(el => {
